...
public class BoardUpdateController {
	...
	public ModelAndView updatepass(int num, int pass, int currentPage) {

		ModelAndView model = new ModelAndView();

		// 비번이 맞으면 수정 폼으로, 틀린 경우 passfail로
		int isPass = dao.getCheckPass(num, pass);
		if (isPass == 1) {
	...
	public String updatedetail(BoardDto dto, String currentPage, @RequestParam ArrayList<MultipartFile> uimage, HttpSession session) {
