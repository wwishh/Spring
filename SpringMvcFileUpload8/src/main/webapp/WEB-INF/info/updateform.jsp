		...
		<table class="table table-bordered" style="width: 400px">
			...
			<tr>
				...
				<td><input type="text" name="name" class="form-control"
					style="width: 120px" value="${dto.name }"></td>
			</tr>

			<tr>
				<th>주소</th>
				<td><input type="text" name="addr" class="form-control"
					style="width: 120px" value="${dto.addr }"></td>
			</tr>
			...
			<tr>
				<th>운전면허</th>
				<td><input type="radio" name="driver" value="있음" ${dto.driver=='있음'?'checked':''}>있음 <input
					type="radio" name="driver" value="없음" ${dto.driver=='없음'?'checked':''}>없음
				</td>
			</tr>
